...
# !git push
# NOTE: thought I'd have to do !git push -u origin master but that didn't work;
# just plain !git push seemed to do the trick and the file showed up in the remote repo
